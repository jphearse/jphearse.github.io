	...
	<div class="container">
		<div class="row centered mt mb">
			<div class="col-lg-8 col-lg-offset-2">
				...
				<div class="alignleft1 indent" "><em>-Completed 500+ hours of hands on training in modern software technologies with a focus on Linux, Apache, MySQL, PHP, Laravel, HTML, CSS, JavaScript, jQuery, and Twitter Bootstrap.</em></div><br><br>
